...
const HeroSection = () => {
  return (
    <section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 sm:flex-wrap-reverse container py-8 ">
        <div className="col-span-7 place-self-center body-font lg:text-center text-left">
          <div className = 'mx-auto'>
            <button className = 'w-[200px] h-[60px] bg-white p-2 text-black hover:shadow-[0_20px_50px_rgba(100,_100,_100,_0.7)] hover:shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)] hover:-translate-y-3 duration-300'>
